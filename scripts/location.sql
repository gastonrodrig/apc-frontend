...
INSERT INTO `provinces` (`province_id`, `name`, `department_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO `districts` (`district_id`, `name`, `province_id`, `department_id`) VALUES
...
UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '03';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '04';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '05';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '06';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '07';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '08';

UPDATE `districts`
SET `type` = 'D'
WHERE `department_id` = '09';
...
UPDATE `elsaval`.`districts` SET `type` = 'A' WHERE (`district_id` = '150140');
UPDATE `elsaval`.`districts` SET `type` = 'A' WHERE (`district_id` = '150130');
UPDATE `elsaval`.`districts` SET `type` = 'B' WHERE (`district_id` = '150131');
UPDATE `elsaval`.`districts` SET `type` = 'B' WHERE (`district_id` = '150114');
UPDATE `elsaval`.`districts` SET `type` = 'B' WHERE (`district_id` = '150122');
